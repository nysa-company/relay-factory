...
const USAGE = "usage: node app/tools/approval-count.js <state-file>\n";
const CANNOT_READ = "approval-count: cannot read state file\n";
const NOT_JSON = "approval-count: state file is not valid JSON\n";
const INVALID_STATE = "approval-count: invalid Relay state\n";
...
function main() {
  ...
  process.stdout.write(`${JSON.stringify({ approvals: state.approvals.length })}\n`);
}

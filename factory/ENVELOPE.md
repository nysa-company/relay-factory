...
Contract 2.0 qualification generation 78 admits only T-219 through T-221 at
capacity three within this $300 disposable-product envelope. The $5 run cap
is calibrated above the observed $2.3021 valid Planner run; the qualification
manifest retains the required extended $10 settlement ceiling.
